...
export const EventCardComponent = () => {
  return (
    <Card className="max-w-xs rounded-xl shadow-lg border border-gray-200 bg-white">
      ...
      <CardBody className="pt-2">
        <div className="flex gap-4">
          ...
          <div>
            ...
            <div className="mt-2 grid grid-cols-2 space-y-2 font-normal text-gray-700 text-sm">
