  ...
  return (
    <div>
      ...
      <div className="bg-gradiantBg py-20">
        ...
        <div>
          <h3 className="text-primary font-extrabold">Evenements à venir</h3>
          <span>Des événements exclusifs, des places limitéesr</span>
        </div>
        <div className=" md:grid space-y-3 md:space-y-0 md:grid-cols-2 lg:grid-cols-3 mx-7 md:mx-14  gap-5 mt-9">
          <EventCardComponent />
          <EventCardComponent />
          <EventCardComponent />
          <EventCardComponent />
