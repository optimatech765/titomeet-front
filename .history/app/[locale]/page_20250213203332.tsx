  ...
  return (
    <div>
      ...
      <div className="bg-gradiantBg py-20 px-7 md:px-14">
        ...
        <section>
          <div>
            <h3 className="text-primary font-extrabold text-4xl font-poppins text-center ">Evenements à venir</h3>
            <span className="text-[#1E1E1E] text-base text-center">Des événements exclusifs, des places limitéesr</span>
            <div className="bg-secondary h-1 max-w-36 mt-1 rounded-tl-md mx-auto "></div>
          </div>
        </section>
      </div>
