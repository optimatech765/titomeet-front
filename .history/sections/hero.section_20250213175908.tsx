        ...
        <section className="bg-white px-6 md:px-12 lg:px-24 py-12">
            <div className="max-w-7xl mx-auto flex  md:flex-row items-center">
                ...
                <div className="lg:w-1/2 flex justify-center">
                    <Card radius="lg" shadow="md" className="rounded-[188px] bg-red-600 max-h-96  overflow-hidden">
                        <CardHeader className="relative h-96 w-full overflow-hidden rounded-t-xl">
                            <Image
