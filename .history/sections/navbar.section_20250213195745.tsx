...
export const NavbarSection = () => {
    ...
    return (
        <Navbar isBordered className="px-6 shadow-md bg-white text-black">
            ...
            <NavbarContent className="hidden md:flex gap-6">
                <NavbarItem>
                    <LinkH as={Link} href="/" className="font-semibold underline-hover text-black">
                        Accueil
                    </LinkH>
                </NavbarItem>
                <NavbarItem>
                    <LinkH as={Link} href="/evenements" className="font-semibold underline-hover text-black">
                        Événements
                    </LinkH>
                </NavbarItem>
                <NavbarItem>
