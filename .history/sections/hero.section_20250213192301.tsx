        ...
        <section className="bg-white px-3 md:px-7 lg:px-14 py-12">
            <div className="max-w-7xl mx-auto flex lg:flex-row items-center justify-between">
                ...
                <div className="lg:w-1/2  lg:text-left">
                    ...
                    <div className="mt-4 bg-hero-pattern bg-red-100 p-2 rounded-full flex items-center gap-4 shadow-md">
                        <Input
                            type="text"
                        ...
                        <Button isIconOnly className="bg-white text-white rounded-full p-3 ml-2 hover:bg-red-600 hover:text-white">
                ...
                <div className="lg:w-1/2 flex justify-end ">
                    <Card radius="lg" shadow="md" className="rounded-[188px] shadow-lg  max-h-[525px] max-w-[525px] overflow-hidden">
                        <Image
                            as={NextImage}
