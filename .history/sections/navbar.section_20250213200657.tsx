...
export const NavbarSection = () => {
    ...
    return (
        <Navbar  className="px-6 shadow-md bg-white text-black" position={"sticky"}>
            ...
            <NavbarContent className="hidden md:flex gap-6">
                <NavbarItem isActive>
                    <LinkH aria-current="page" underline-hover underline="active"  as={Link} href="/" className="font-semibold underline-hover text-black">
                        Accueil
                    </LinkH>
                </NavbarItem>
                <NavbarItem>
