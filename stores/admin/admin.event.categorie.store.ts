...
import { AdminEventCategorieServices } from '@/services/admin/admin.event.categorie.service';
...
export const useAdminEventCategoriesStore = create<HookInterface>((set) => ({
    DataListConfig: {
        page: 1,
        totalItems: 0,
        perPageItems: 25,
